...
<figure class="">
	<video class="shadow rounded" type="video/mp4" src="https://storage.googleapis.com/womp-website_cloudbuild/cdn/womp-website/video/overwatch_clips.mp4" autoplay="true" loop="true" video muted="true" style="height: 100%; width: 100%; object-fit: cover;" alt="Video Of Clips From Live Stream"></video>
